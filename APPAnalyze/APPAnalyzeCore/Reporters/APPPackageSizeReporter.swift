...
enum APPPackageSizeReporter: Reporter {
    ...
    static func packageSize() -> AppPackageSize {
        ...
        //
        return AppPackageSize(allSize: allSize, binarySize: allBinarySize, resourceSize: allResourceSize, components: componentSizeInfos)
    }
}
